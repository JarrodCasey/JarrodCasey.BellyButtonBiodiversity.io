// 1. Create a horizontal bar chart with drop down menu to display top 10 OTUs found in that individual

// Create a function to build the chart
function buildChart(patientID) {
    ...
    // Create sample_values variable for bar chart
    var sample_values = filteredSample.sample_values

    // Create otu_ids variable for bar chart
...
// 2. Create function to pupolate the data
...
// 3. Create function to govern for changing of options
...
// 4. Create function to initiaise the dashboard
